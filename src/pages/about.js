...
import Me2 from "../images/Jameslinkedinpic.png";
    ...
    <Layout>
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="h-96 ml-8 mr-8 flex flex-col mt-40 mb-80 md:mt-5 max-w-3xl text-center justify-center items-center">
          ...
          <p className="text-md sm:text-xl mt-5">
            I have been coding nearly every day for 4 years now. The past year and half I have been working at  <a
              className="textSiteGreen"
              href="https://shape.works"
            >
              Shape Works
            </a> helping them build websites with React, SASS, PHP and JavaScript. I find development
