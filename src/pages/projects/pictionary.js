    ...
    <>
      <Layout>
        <div className="mt-20 ml-5 mr-5 sm:ml-20 sm:mr-20 lg:ml-60 lg:mr-60 mb-28">
          <h1 className="font-bold text-3xl">Pictionary</h1>
          ...
          <div className="mt-10 ">
            <div className="flex flex-col justify-center items-center sm:flex sm:flex-row">
              <img className="sm:w-1/3 m-3" src={PictionaryPic} alt="" />
              <img className="sm:w-1/3 mn-3" src={PictionaryPic} alt="" />
            </div>
            <div className="ml-10 mr-10 mt-5 flex justify-center items-center">
              <img className="w-2/3" src={PictionaryPic} alt="" />
            </div>
          </div>
